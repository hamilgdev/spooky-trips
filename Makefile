...
frontend.start_dev:
	...
	--rm --name host-spooky-trips-nextjs-dev-frontend \
...
frontend.start_prod:
	...
	--rm --name host-spooky-trips-nextjs-prod-frontend \
	--no-deps --service-ports frontend \
...
backend.start_dev:
	docker compose -f docker-compose.dev.yml run \
	--rm --name host-spooky-trips-nestjs-dev-backend \
...
backend.start_prod:
	docker compose -f docker-compose.prod.yml run \
	--rm --name host-spooky-trips-nestjs-prod-backend \
	--service-ports backend \
...
backend.multi_platform.build_prod:
	...
	-t hamilgdev/spooky-trips-nestjs-prod-backend:latest \
